...
//I changed these numbers so that the start point of the wall is determined
float xr = 0;
float yr = -0.5;
float theta = 0;
...
/* end setup section ***************************************************************************************************/
 ...
 /* Commented out this part so that I would not have random points
...
while(1==1) {
    ...
    if(haplyBoard.data_available()){
     ...
     // // I also edited this part, 
     //if (yr <= -0.5 && xr <=0.5){
     //   xr = xr+0.0001;
     // }
     // else if (xr >= 0.5 && xr > 0 && yr <= 0.5){
     //   yr = yr + 0.0001;
     // }
     // else if (yr >= 0.5 && xr >= -0.5){
     //   xr = xr - 0.0001;
     // }
     // else if (xr <= -0.5 && xr <= 0 && yr >= -0.5){
     //   yr = yr - 0.0001;
     // }
      ...
      else if ( xr>=0.5 || yr>=0.25 && theta <= 3.14){
        xr = 0.5*cos(theta) + 0;
        yr = 0.5*sin(theta) +0.25;
        theta=theta+0.0001;
      }
